<?php 
 ...
 //print_r('senha: ' . $_POST['senha']);
   ...
   $result = mysqli_query($conexao, "INSERT INTO alunos(Nome,RA,Digito) VALUES ('$Nome','$RA','$Digito')");
...
<body>
    <div class="main-login">
        <div clas="left-login">
       <center> <h1>Faça seu cadastro <br> 
       </h1></center>
        ...
        <
            ...
            <h1>CADASTRE-SE</h1>              
                ...
                <form action="tela_cadastro2.php" method="POST">
            <div class="textfield">
