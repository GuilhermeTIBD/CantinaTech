...
<body>
    <div class="main-login">
       ...
       <center> <h1>EDITAR<br> 
        ...
        <input type="text" name="id" id="id" class="inputUser" value ="<?php echo $id ?>">
        ...
        <input type="text" name="preco" id="preco" class="inputUser" value ="<?php echo $preco ?>">


        <div class="textfield">
        <label for="quantidade_estoque" class="labelInput">Quantidade</label>
        <input type="text" name="quantidade_estoque" id="quantidade_estoque" class="inputUser" value ="<?php echo $quantidade_estoque ?>">
<br>
