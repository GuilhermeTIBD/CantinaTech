        ...
        <div class="right-login">
          <div class="card-login">
            ...
            <h1>LOGIN</h1>     <br>     
                ...
                <div class="textfield">
    <label for="usuario">RA(0001234567)</label>
    <input type="text" name="RA" placeholder="RA" maxlength="12" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
</div>

        <div class="textfield">
    <label for="Digito">Ultimo Digito</label>
    <input type="text" name="Digito" placeholder="Digito" maxlength="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
</div>
           ...
           <br>
           <br> 
           <button class="input"><a href="tela_cadastro2.php" style="text-decoration: none; color: inherit;">REGISTRAR</a></button>
